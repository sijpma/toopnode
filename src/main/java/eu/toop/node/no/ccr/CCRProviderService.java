...
public class CCRProviderService extends RestClient {
	...
	public ChamberOfCommerceDataSet getDataSet(String orgNo) throws IOException {
		...
		set.setRegistrationDate(root.get("stiftelsesdato") == null ? Constants.NOT_AVAILABLE : root.get("stiftelsesdato").asText());
		set.setRegistrationNumber(Constants.NOT_APPLICABLE);
